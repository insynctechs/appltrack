<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="recruiter_webapp.User" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col s6 m6 l6">
        <div class="row">
            ...
            <div class="input-field col s12">
                <input type="text" id="user_type_name" name="user_type_name" value="<%:userList[0]["name"]%>" />
