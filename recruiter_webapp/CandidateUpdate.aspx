    ...
    <form id="frm_job" runat="server" enctype="multipart/form-data">
        ...
        <div class="row no-padding">
            <div class="col s12 m12 l8 card grey lighten-2 padding-1 border-radius-5 no-margin padding-1">
                ...
                <a href="<%= WebURL %>CandidateDocUpdate?id=<%:Request.QueryString["id"]%>" class="btn waves-effect waves-light blue lighten-1 right">Edit Documents</a>
                <%}%>
            </div>
        </div>
        ...
        <div class="row">
            <div class="input-field col s12 m12 l8 card white lighten-3 z-depth-3 padding-3 border-radius-5">
                ...
                <div class="row">
                    <div class="col s2 input-field switch left">
                        <label>
                            Active<input type="checkbox" id="active" class="filled-in blue lighten-3" <%= (candidateList.Count > 0) ? (candidateList[0]["active"] == null) ? "checked" : (candidateList[0]["active"].ToString() == "1") ? "checked" : ""  : "checked" %> />
   ...
   round-co or: 
    ...
    <script>
        $(document).ready(function () {
            ...
            function isEqualOrGreater(o, n, min) {
                if (parseInt(o.val()) < min.val()) {
                    o.addClass("ui-state-error");
                    updateTips("Must be a valid year greater than or equal to " +
                        min + ".");
                    return false;
                } else {
                    return true;
            ...
            function validateExpDialogFields() {
                ...
                valid = valid && isEqualOrGreater(to_year, "To year", from_year);
