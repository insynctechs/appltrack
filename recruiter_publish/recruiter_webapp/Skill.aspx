                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <%-- <a href="<%:WebURL%>SkillUpdate?<%#Server.UrlEncode("id="+Eval("id"))%>">URLEncoded Link</a> --%>
                                        <a id="<%#Eval("RowNumber")%>" class="btn-delete white-text waves-light blue lighten-1 padding-2 border-radius-5" href="<%= WebURL %>Skill/Delete?id=<%#Eval("id")%>">Delete </a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
